  ...
  return (
    <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide px-2 py-2">
      ...
      <button
        ...
        className="shrink-0 w-[42px] rounded-lg border-2 border-dashed border-gray-300 dark:border-white/15 flex items-center justify-center text-gray-400 hover:border-accent-500 hover:text-accent-500 transition-colors"
