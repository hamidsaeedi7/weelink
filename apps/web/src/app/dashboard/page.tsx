...
const STATS = [
  ...
  { label: "کلیک لینک‌ها", value: "۰", icon: MousePointer, color: "text-accent-400", bg: "bg-accent-500/10" },
...
export default function DashboardPage() {
  return (
    <div className="space-y-8">
      ...
      {/* Setup Banner */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-accent-500 to-accent-600 p-6">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between">
          <div className="text-white">
            ...
            <div className="text-accent-100 text-sm mt-1">لوگو، بیو و اولین لینک را اضافه کن</div>
          </div>
          <Link href="/dashboard/blocks"
            className="flex-shrink-0 bg-gray-100 text-accent-600 font-bold px-5 py-2.5 rounded-xl
